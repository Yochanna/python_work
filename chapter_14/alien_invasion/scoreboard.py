...
class Scoreboard:
    ...
    def prep_high_score(self):
        ...
        high_str = f"High: {high:,}"
        self.high_score_image = self.font.render(high_str, True, self.text_color, None)
    ...
    def prep_ships(self):
        # Simple text for ships left (you can draw mini ships later if you like)
        ships_str = f"Lives: {self.stats.ships_left}"
        self.ships_image = self.font.render(ships_str, True, self.text_color, None)
